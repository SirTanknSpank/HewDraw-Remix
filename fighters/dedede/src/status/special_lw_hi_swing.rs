...
unsafe extern "C" fn special_lw_hi_swing_pre(fighter: &mut L2CFighterCommon) -> L2CValue{
...
unsafe extern "C" fn special_lw_hi_swing_main(fighter: &mut L2CFighterCommon) -> L2CValue{
    MotionModule::change_motion(fighter.module_accessor, Hash40::new("special_lw_hi_swing"), 0.0, 1.0, false, 0.0, false, false);
...
unsafe extern "C" fn special_lw_hi_swing_main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if StatusModule::is_situation_changed(fighter.module_accessor){
        if fighter.is_situation(*SITUATION_KIND_GROUND){
            if MotionModule::frame(fighter.module_accessor) < 45.0 && !fighter.is_motion(Hash40::new("landing_heavy")){
                MotionModule::change_motion(fighter.module_accessor, Hash40::new("special_lw_hi_swing_landing"), 0.0, 1.0, false, 0.0, false, false);
            }
            else{
                ...
                MotionModule::change_motion(fighter.module_accessor, Hash40::new("landing_heavy"), 0.0, 1.0, false, 2.0, false, false);
...
pub fn install(){
    CustomStatusManager::add_new_agent_status_script(
        ...
        StatusInfo::new()
            ...
            .with_end(special_lw_hi_swing_end)
    );
}